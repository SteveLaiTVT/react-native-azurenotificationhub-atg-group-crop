...
def convert_class(j_class, j_package):
    ...
    c_class.set('filename', os.path.dirname(os.path.abspath(__file__)) + '/node_modules/react-native-azurenotificationhub-atg-group-crop/android/src/main/java/' + guess_filename(j_class.attrib['name']))
